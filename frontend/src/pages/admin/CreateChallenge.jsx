...
const CreateChallenge = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        bibUrl: '',
        rules: '',
        options: [{ name: '', price: '', originalPrice: '', description: '' }],
        activityTypes: 'Run' // Default to Run
    });
    ...
    return (
        <div className="glass rounded-2xl p-8 max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-6">Tạo Thử Thách Mới</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end gap-3 pt-4">
                    ...
                    >
                        {isLoading ? 'Đang Tạo...' : <><Save size={18} /> Tạo Thử Thách</>}
                    </button>
                </div>
            </form>
        </div>
