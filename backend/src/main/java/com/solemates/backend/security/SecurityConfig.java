    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyRole("ADMIN", "CHALLENGE_MANAGER")
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/challenges/**")
                        .hasAnyRole("ADMIN", "CHALLENGE_MANAGER")
                        .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/challenges/**")
                        .hasAnyRole("ADMIN", "CHALLENGE_MANAGER")
